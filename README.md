...
| 메인      | `/dashboard`, `/tools`                                                       | 위치 chip, 종 카드, lifecycle rail, **이번 주 활동 strip**, **오늘의 컨디션 위젯**(health/habitat/budget/supplies), **다가오는 일정 preview**(D-3 toast + browser notification) / **도구 모음 허브**(63개 도구 10개 카테고리 그룹·검색) |
