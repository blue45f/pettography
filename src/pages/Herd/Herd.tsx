...
import { monthBreakdown, useBudgetStore } from '@features/budget'
...
import { useOnboardingStore, type PetProfile } from '@features/onboarding'
import { REGISTRY_FILINGS, useRegistryStore } from '@features/registry'
