...
/**
 * 약관/개인정보처리방침 정본은 TermsDesk(중앙 정책 게시 서비스)에서
 * 무인증 공개 API로 제공된다. 앱 자체 백엔드와 무관한 외부 절대 URL이라
 * `@infrastructure/api`(자체 API base 전제) 대신 표준 fetch를 직접 사용한다.
 */
export const TERMSDESK_BASE_URL = 'https://termsdesk.vercel.app'
export const POLICY_ORG_SLUG = 'pettography'
