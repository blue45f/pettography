 ...
 * ──────────────────────────────────────────────────────────────────────────
 * SurveyDesk npm publish 가 막힌 동안 형제 앱(여기선 pettography)에 그대로
 * 복붙해서 쓰는 버전입니다. 원본: surveydesk/apps-vendor/FeedbackWidget.tsx.
 * 워크스페이스 의존(@surveydesk/shared) 0 — 필요한 상수·검증 로직을 이 파일에 인라인했습니다.
 * 자체 주입 스타일(scoped .sd-*)을 쓰므로 앱의 Tailwind/OKLCH 토큰과 충돌하지 않습니다.
 *
 * 사용:
 *   import { FeedbackWidget } from '@components/feedback/FeedbackWidget'
 *   <FeedbackWidget appId="pettography" endpoint="https://surveys.example.com" />
 *
 * 백엔드 계약(공개·무인증):
